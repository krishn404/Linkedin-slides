...
export default function LandingPage() {
  ...
  return (
    <div className="flex flex-col min-h-[100dvh] bg-[#000000] text-[#000000E6]">
      ...
      <main className="flex-1">
          ...
          <div className="container px-4 md:px-6">
            <div className="text-center max-w-3xl mx-auto space-y-8">
              ...
              <div className="flex flex-col gap-4 items-center">
                ...
                <Link href="#learn-more" className="text-sm text-[#00000099] hover:text-[#000000E6]">
                  Learn more
        ...
        <section ref={dashboardRef} className="w-full py-20">
          <div className="container px-4 md:px-6">
            <div className="rounded-2xl border border-[#00000014] bg-white p-8 backdrop-blur-sm overflow-hidden">
              <div className="h-[400px] flex items-center justify-center">
                <div className="text-center">
                  <h3 className="text-3xl md:text-4xl font-bold mb-4 text-[#0A66C2]">
                    {["Give Prompt", "Generate Slides", "Customize Slides", "Export & Share"][slideIndex]}
                  </h3>
                  <p className="text-xl text-[#00000099]">Step {slideIndex + 1} of 4</p>
                </div>
              </div>
            </div>
          </div>
        ...
        <section ref={featuresRef} className="w-full py-20 bg-white">
          <div className="container px-4 md:px-6">
            ...
            <div className="grid gap-8 md:grid-cols-2 lg:grid-cols-3">
              <div className="rounded-2xl border border-[#00000014] bg-white p-8 backdrop-blur-sm">
